...
pscan = SUBARGS.add_parser('scan', help='Scan KNXnet/IP gateways')
pscan.add_argument(
...
psearch = SUBARGS.add_parser('search', help='Search for KNXnet/IP gateways')
...
pwrite = SUBARGS.add_parser('write', help='Write value to group address')
pwrite.add_argument(
    'targets', help='KNXnet/IP gateway', metavar='gateway')
pwrite.add_argument(
    'group_write_address', help='A KNX group address')
pwrite.add_argument(
...
pmonitor = SUBARGS.add_parser('monitor', help='Monitor bus messages')
